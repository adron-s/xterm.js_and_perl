...
#***************************************************
#подготавливает и запускает целевую команду при
...
#***************************************************
#защита от разделения буфера на куски по 4095 байт
#
#т.к. у нас используется UTF8 кодировка то такое разделение
#может "разорвать" последний символ на два кусочка.
#эта ф-я учитывает такую возможность и проверяет последние
#6 байт(макс. размер в байтах одного символа в юникода)
#на целостность согласно спецификации UTF8.
...
#***************************************************
#создает и подготавливает pty для целевой команды
